...
async def helpstr(message: types.Message):
    ...
    btns = types.InlineKeyboardButton("Channel", url="https://t.me/elitesquad1")
...
async def ch(message: types.Message):
    ...
    try:
        ...
        load = {
            ...
            "muid": Muid,
            "sid": Sid,
            "key": "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",
            "card[name]": Name,
            "card[number]": ccn,
            "card[exp_month]": mm,
            "card[exp_year]": yy,
